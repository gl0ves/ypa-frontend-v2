			...
			<div class="w-full space-y-3">
				<div>
					<FormLabel width="w-full" textColor="text-black" label="First Name">
						<Input bind:value={firstname} placeholder="John" class="w-full" />
					</FormLabel>
				</div>
				<div>
					<FormLabel width="w-full" textColor="text-black" label="Last Name">
						<Input bind:value={lastname} placeholder="Doe" class="w-full" />
					</FormLabel>
				</div>
				<div>
					<FormLabel width="w-full" textColor="text-black" label="Email">
						<Input bind:value={email} placeholder="example@gmail.com" class="w-full" />
					</FormLabel>
				</div>
				<div>
					<FormLabel width="w-full" textColor="text-black" label="Phone number incl. country code">
						<Input bind:value={phone} placeholder="+31 618 472 480" class="w-full" />
					</FormLabel>
				</div>
				<div>
					<FormLabel
						...
						label="What would you like information on? (optional)"
					>
